...
\tikzstyle{vertex} = [circle, draw, minimum size=18pt, thick]
\tikzstyle{selected vertex} = [circle, fill=red!60]
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[scale=1.6]
    \node[vertex, fill=yellow] (01) at (1,4) {1};
    \node[vertex, fill=yellow] (02) at (0,3) {2};
    \node[vertex] (03) at (0,2) {3};
    \node[vertex, fill=yellow] (04) at (1,3) {4};
    \node[vertex] (05) at (1,2) {5};
    \node[vertex] (06) at (1,1) {6};
    \node[vertex] (07) at (1,0) {7};
    \node[vertex] (08) at (2,2) {8};
    \node[vertex] (09) at (2,1) {9};
    \node[vertex] (10) at (2,3) {10};
    \node[vertex] (11) at (3,2) {11};
...
\begin{figure}[ht]
  ...
  \begin{minipage}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.03]
      \node[vertex][fill=green!80] (00) at (238.2, 119)     {p};
      \node[vertex] (01) at (164.8, 103.4)   {};
      \node[vertex] (02) at (182.1, 169.7)   {};
      \node[vertex] (03) at (286.2, 167.5)   {};
      \node[vertex] (04) at (211.1, 220)     {};
      \node[vertex] (05) at (282.5, 238.1)   {};
      \node[vertex] (06) at (133.5, 215.9)   {};
      \node[vertex][fill=orange!80] (07) at (165.5, 279.4)   {s};
      \node[vertex] (08) at (235.7, 291.2)   {};
  ...
  \begin{minipage}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.03]
      \node[vertex][fill=green!80] (00) at (238.2, 119)     {p};
      \node[vertex][fill=green!60] (01) at (164.8, 103.4)   {};
      \node[vertex][fill=green!60] (02) at (182.1, 169.7)   {};
      \node[vertex][fill=orange!60] (03) at (286.2, 167.5)   {};
      \node[vertex][fill=orange!60] (04) at (211.1, 220)     {};
      \node[vertex][fill=orange!60] (05) at (282.5, 238.1)   {};
      \node[vertex][fill=orange!60] (06) at (133.5, 215.9)   {};
      \node[vertex][fill=orange!80] (07) at (165.5, 279.4)   {s};
      \node[vertex][fill=orange!60] (08) at (235.7, 291.2)   {};
